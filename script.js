// const blob = new Blob(['importScripts("static/js/lzma_worker.min.js");']);
const lzma = new LZMA("static/js/lzma_worker.min.js");
...
const initCodeEditor = () => {
    ...
    CodeMirror.modeURL = "static/js/CodeMirror-5.58.1/mode/%N/%N.js";
